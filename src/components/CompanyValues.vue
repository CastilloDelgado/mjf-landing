...
<template>
    <div
        class="w-full md:py-12 py-0 bg-storm-gray-100  md:bg-gradient-to-r md:from-storm-gray-100  md:from-50% md:via-50% md:via-hillary-500 md:to-100% md:to-hillary-500 ">
